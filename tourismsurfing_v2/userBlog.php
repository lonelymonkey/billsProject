...
// enable if want access;
  ...
  elseif (isset($_POST['userLogout'])) {
// unset flag and terminate session
...
// redirect user back to login page
  ...
  */
  ...
  <form method="post" enctype="multipart/form-data">
    ...
    </br> <span class="error">* '.$errorMsg["gender"].'</span> </br>
  </div>
  <div >
    ...
    <input type="submit" value="logout" name="userLogout">
  </form>
  <!--
